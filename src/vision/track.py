...
def update_detections(results, model, camera_id, camera_name, camera_uniqueID, model_name, fps):
...
def format_tracking_info(camera_name, width, height, fps, avg_fps, elapsed_time, total_objects, detected_objects, results):
