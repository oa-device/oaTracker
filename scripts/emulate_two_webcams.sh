...
ffmpeg -nostats -loglevel 0 -stream_loop -1 -re -i "$SCRIPTS_DIR"/video-$NAME_A-10.mp4 -f v4l2 -vcodec rawvideo -s 1920x1080 /dev/video$DEVICE_NUMBER_A &
ffmpeg -nostats -loglevel 0 -stream_loop -1 -re -i "$SCRIPTS_DIR"/video-$NAME_B-10.mp4 -f v4l2 -vcodec rawvideo -s 1920x1080 /dev/video$DEVICE_NUMBER_B &
