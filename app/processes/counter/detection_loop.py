...
class CounterLoop():
    ...
    def __init__(self, args: Args, all_counters,
    ...
    def log_visualization(self, result: ultralytics.engine.results.Results, cam_ts: float, shared_memory_img: mmap.mmap) -> None:
